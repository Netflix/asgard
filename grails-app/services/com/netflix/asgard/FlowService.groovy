...
class FlowService implements InitializingBean {
    ...
    void afterPropertiesSet() {
        ...
        identity = ManagementFactory.runtimeMXBean.name
        simpleWorkflow = simpleWorkflow ?: awsClientService.create(AmazonSimpleWorkflow)
        activityImplementations.each { Spring.autowire(it) }
        workflowWorker = workflowWorker ?: new WorkflowWorker(simpleWorkflow, domain, domain)
    ...
    /**
     * Create a workflow client that allows you to schedule a workflow by calling methods on the workflow interface.
     *
    ...
    /**
     * Get an existing workflow. Useful for canceling, terminating or just looking at attributes of the workflow.
     *
    ...
    /**
     * Manual activities do not complete automatically. With a ManualActivityCompletionClient you can revisit an
     * executing manual activity and complete it as you see fit.
     *
