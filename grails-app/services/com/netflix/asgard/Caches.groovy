...
class Caches {
    ...
    Caches(CachedMapBuilder cachedMapBuilder, ConfigService configService = null) {
        ...
        allAutoScalingGroups = cachedMapBuilder.of(EntityType.autoScaling, 10).buildMultiRegionCachedMap()
        allLaunchConfigurations = cachedMapBuilder.of(EntityType.launchConfiguration, 10).buildMultiRegionCachedMap()
        allLoadBalancers = cachedMapBuilder.of(EntityType.loadBalancer, 10).buildMultiRegionCachedMap()
        ...
        allKeyPairs = cachedMapBuilder.of(EntityType.keyPair, 10).buildMultiRegionCachedMap()
        allImages = cachedMapBuilder.of(EntityType.image, 10).buildMultiRegionCachedMap()
        allInstances = cachedMapBuilder.of(EntityType.instance, 10).buildMultiRegionCachedMap()
        allSpotInstanceRequests = cachedMapBuilder.of(EntityType.spotInstanceRequest, 120).buildMultiRegionCachedMap()
        allApplicationInstances = cachedMapBuilder.of(EntityType.applicationInstance, 10).buildMultiRegionCachedMap()
        allReservedInstancesGroups = cachedMapBuilder.of(EntityType.reservation, 3600).buildMultiRegionCachedMap()
        allSecurityGroups = cachedMapBuilder.of(EntityType.security, 10).buildMultiRegionCachedMap()
        allSnapshots = cachedMapBuilder.of(EntityType.snapshot, 10).buildMultiRegionCachedMap()
        allVolumes = cachedMapBuilder.of(EntityType.volume, 10).buildMultiRegionCachedMap()
        ...
        allScalingPolicies = cachedMapBuilder.of(EntityType.scalingPolicy, 10).buildMultiRegionCachedMap()
