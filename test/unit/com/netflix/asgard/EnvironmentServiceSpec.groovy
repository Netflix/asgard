...
class EnvironmentServiceSpec extends Specification {
    ...
    void 'should get environment variable from System'() {
        System.metaClass.static.getenv = { String key -> return 'world' }

        expect:
        new EnvironmentService().getEnvironmentVariable('HELLO') == 'world'
    }

    void 'should get the local instance id from AWS helper class'() {
        EC2MetadataUtils.metaClass.static.getInstanceId = { 'i-deadbeef' }
