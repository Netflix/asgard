...
enum AutoScalingProcessType {
    ...
    static Set<AutoScalingProcessType> getPrimaryProcesses() {
        EnumSet.of(Launch, Terminate)
    }

    static Set<AutoScalingProcessType> getUpdatableProcesses() {
        EnumSet.of(Launch, Terminate, AZRebalance, AddToLoadBalancer)
    }
}
