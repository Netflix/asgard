...
enum Region {
    ...
    Region(String code, String pricingJsonCode, String mapImageFileName, String location, String provider) {
        this(code, pricingJsonCode, mapImageFileName, location)
    ...
    String getProvider() { provider.toLowerCase() }
}
