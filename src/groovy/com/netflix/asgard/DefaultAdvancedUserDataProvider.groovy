...
class DefaultAdvancedUserDataProvider implements AdvancedUserDataProvider {
    ...
    String buildUserDataForCloudObjects(LaunchContext deploymentContext) {
        ...
        UserContext userContext = deploymentContext.userContext
        String groupName = deploymentContext.autoScalingGroup.autoScalingGroupName
        String launchConfigName = deploymentContext.launchConfiguration.launchConfigurationName
